package io.hbt.commerce.constant;
...
public class ClientExceptionConstant {
    ...
    public static final String ADMINISTRATOR_EMAIL_NOT_EXIST_ERRCODE = "" ;
    public static final String ADMINISTRATOR_EMAIL_NOT_EXIST_ERRMSG = "";
}
